package com.supaur.framework.pageObjectConfig;
...
public class PageObjectAutoCode {
	...
	static  String path="src/main/java/com/supaur/framework/pageObjectConfig/LabelCreate.xml";
	public static void autoCode() throws Exception
	{
		...
		for(Iterator<?> i=root.elementIterator();i.hasNext();)
		{
			...
			sb.append("import com.supaur.framework.seleniumTool.BaseAction;\n");
			sb.append("import com.supaur.framework.seleniumTool.Locator;\n");
			sb.append("import com.supaur.framework.pageObjectConfig.PageObjectAutoCode;");
			...
			sb.append("private String path=\"src/main/java/com/supaur/framework/pageObjectConfig/LabelCreate.xml\";\n");
			...
			File pageObjectFile=new File("src/main/java/com/supaur/framework/pageObject/"+pageClassName+".java");
